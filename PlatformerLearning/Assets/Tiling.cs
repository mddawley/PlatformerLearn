...
public class Tiling : MonoBehaviour {
    public int offsetX = 2;         // the offset to prevent errors

    // these are used for checking if buddies need to be instantiated
    ...
    void MakeNewBuddy (int rightOrLeft) {
        ...
        // instatiating our new buddy and storing him in a variable
